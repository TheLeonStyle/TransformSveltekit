...
function Intro($$payload, $$props) {
  ...
  $$payload.out += `<section class="intro svelte-1nfnyjb" aria-labelledby="intro-title"${attr_style(`background-image: url(${STRAPI_URL}${dataIntro.background.url})`)}><div class="intro__container svelte-1nfnyjb"><div class="intro__wrapper svelte-1nfnyjb">`;
  {
    $$payload.out += "<!--[-->";
    $$payload.out += `<div class="intro__content svelte-1nfnyjb" aria-labelledby="intro-title" data-aos="fade-left" data-aos-delay="300"><h1 id="intro-title" class="intro__title svelte-1nfnyjb" data-aos="fade-left" data-aos-delay="1000">${escape_html(dataIntro.title)}</h1> <p class="intro__subtitle svelte-1nfnyjb" data-aos="fade-left" data-aos-delay="500">${escape_html(dataIntro.subtitle)}</p> <a href="/services" class="intro__button svelte-1nfnyjb"${attr("aria-label", dataIntro.button)} data-aos="fade-left">${escape_html(dataIntro.button)}</a></div>`;
  }
...
//# sourceMappingURL=_page.svelte-CXp6BVsX.js.map
